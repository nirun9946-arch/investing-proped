...
# (batch ยิงครั้งเดียวได้ทุกตัว จึงอุ่นถี่ได้โดยไม่กวน Yahoo มากกว่าเดิม)
# ตั้ง 4 วิ ไม่ใช่ 2: บนเซิร์ฟเวอร์เจอฟีด batch ถูกปิดทั้งฟีด ซึ่งน่าจะเป็นผลจากการยิงถี่เกิน
# ผู้ใช้แทบไม่รู้สึกต่าง (ฝั่งเว็บ poll ทุก 3 วิอยู่แล้ว) แต่ลดโอกาสโดนกันลงครึ่งหนึ่ง
